...
namespace uvrp.Controllers
{
    public class VideosController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Title,VideoLink")] Video video)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title,VideoLink")] Video video)
        {
            if (ModelState.IsValid)
            {
